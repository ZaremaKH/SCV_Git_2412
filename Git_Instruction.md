...
Для работы в команде используются удаленные репозитории. Одним из популярных сервисов для организации работы удаленных репозиториев является **GitHub**. Lля полноценной работы с данным сервисом необходимо создать аккаунт на сайте GitHub (github.com).
...
Чтобы созданный нами локально
репозиторий оказался на GitHub необходимо
